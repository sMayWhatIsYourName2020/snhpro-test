...
* Отображение цветов у папок и заметок✔️
* Адаптивная верстка✔️
* Обработка ошибок с сервера✔️
* Валидация форм на клиенте✔️
* Реализовать перемещение заметок в другие папки✔️
* Использование Markdown для отображения текста заметки✔️
* Обеспечить автоматическую сборку и размещение сайта на Github Pages с помощью Github Actions (Gitlab Pages с помощью Gitlab CI) **- на GitHub Pages не вышло❌, но вышло на Vercel.✔️**
